...
public class XInt {
    ...
    public int getLowerBound(int index) throws JMException {
        if (type_.getClass() == IntSolutionType.class) {
            ...
            Configuration.logger_.severe("jmetal.util.wrapper.XInt.getLowerBound, solution type " + type_ + "+ invalid");
        }
        return 0;
    }
    ...
    public int getUpperBound(int index) throws JMException {
        if (type_.getClass() == IntSolutionType.class) {
            ...
            Configuration.logger_.severe("jmetal.util.wrapper.XInt.getUpperBound, solution type " + type_ + "+ invalid");
        }
        return 0;
    }
